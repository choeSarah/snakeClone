// Author: Daniel Kopta, May 2019, Travis Martin 2023, Sarah Choe and Anand Palukuri November 2023,
...
public class NetworkTests
{
    ...
    [TestMethod]
    public void TestConnectAndStopServer()
    {
        NetworkTestHelper.SetupSingleConnectionTest(out testListener, out testLocalSocketState, out testRemoteSocketState);
        Assert.IsNotNull(testLocalSocketState);
        Assert.IsNotNull(testRemoteSocketState);
    ...
    [TestMethod]
    public void TestSendTinyMessageWithInvalidSocket()
    {
        ...
        SocketState state = new SocketState(saveClientState,"This is a test");
        ...
        Assert.IsTrue(testClient);
    }

    [TestMethod]
    public void TestSendTinyMessageWithSendAndClose()
    {
        SetupTestConnections(true, out testListener, out testLocalSocketState, out testRemoteSocketState);
    ...
    [TestMethod]
    public void TestConnectwithvalidIPAddress()
    {

        SocketState? clientResult = null;
        SocketState? serverResult = null;
        bool isCalledClient = false;
        bool isCalledServer = true;
        ...
        Networking.ConnectToServer(saveClientState, "123" , 2112);

        NetworkTestHelper.WaitForOrTimeout(() => (clientResult != null) && (serverResult != null), 5000);


        Assert.IsTrue(isCalledClient);
        Assert.IsTrue(isCalledServer);
        Assert.IsTrue(clientResult?.ErrorOccurred);
    }

    [TestMethod]
    public void TestConnectwithoutvalidIPAddress()
    {
        bool isCalled = false;
        ...
        testListener = Networking.StartServer(saveServerState, 2112);
        Networking.ConnectToServer(saveClientState, "invalid", 2112);
